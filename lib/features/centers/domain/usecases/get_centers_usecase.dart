...
class GetCentersUseCase extends BaseUseCase<String, List<CenterEntity>> {
  final CentersRepository _repository;

  GetCentersUseCase(this._repository);

  @override
  Future<Either<Failure, List<CenterEntity>>> execute(String input) async {
    return await _repository.getCenters(input);
  }
}
